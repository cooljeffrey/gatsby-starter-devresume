$(function () {
  ...
  QUnit.test(
    "should set .modal's scroll top to 0 if .modal-dialog-scrollable and modal body do not exists",
    function (assert) {
      assert.expect(1);
      var done = assert.async();
  ...
  QUnit.test(
    "should not close modal when clicking outside of modal-content if backdrop = static",
    function (assert) {
      assert.expect(1);
      var done = assert.async();
      var $modal = $(
